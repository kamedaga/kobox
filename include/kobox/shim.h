...
int kb_handle_device_irqs(kb_device_backend_t *backend, size_t device_index, uint64_t timeout_ns);
...
void *kb_alloc_netdev_mqs(int sizeof_priv, const char *name, void (*setup)(void *), unsigned int txqs, unsigned int rxqs);
void *kb_alloc_netdev_mqs_modern(int sizeof_priv, const char *name, unsigned char name_assign_type, void (*setup)(void *), unsigned int txqs, unsigned int rxqs);
