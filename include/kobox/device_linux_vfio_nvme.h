...
typedef struct kb_linux_vfio_nvme_provider kb_linux_vfio_nvme_provider_t;

kb_status_t kb_linux_vfio_nvme_provider_create(
    const char *pci_bdf,
    kb_linux_vfio_nvme_provider_t **out_provider);
